...
const API_KEY = 'e177c655c168adcc2624d6b96570a6ad'
...
window.onload = function (){
    ...
    .then(({data}) => {
        if(data.length > 0){
            ...
            historyElm.innerHTML = 'There is Not History'
        }
    })
    .catch(e => {
        console.log(e)
...
function getWeatherData(city = DEFAULT_CITY,coords,cb){
    ...
    city === null ?
    url = `${url}&lat=${coords.latitude}&lon=${coords.longitude}` : url = `${url}&q=${city}`
